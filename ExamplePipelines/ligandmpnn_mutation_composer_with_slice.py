"""
This pipeline shows how to generate a lot of LigandMPNN sequences, slice the first 10 for folding,
...
This allows comparison between the first 10 sequences from LigandMPNN vs the 10 generated by MutationComposer.
"""
...
pipeline = Pipeline(
    pipeline_name="LigandMPNN-MutationComposer-WithSlice", #Will create a folder in /shares/USER/<pipeline_name>
...
all_analysis=[analysis_first10]  # Include first 10 analysis
