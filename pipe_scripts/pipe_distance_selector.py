...
Usage:
    python pipe_distance_selector.py <structures_json> <reference_spec> <distance> <restrict_spec> <output_csv> <include_reference>
...
def analyze_structure_distance(structure_id: str, pdb_file: str, reference_spec: str, distance_cutoff: float, restrict_spec: str = "", include_reference: bool = True) -> Dict[str, any]:
    """
...
def main():
    if len(sys.argv) != 7:
        print("Usage: python pipe_distance_selector.py <structures_json> <reference_spec> <distance> <restrict_spec> <output_csv> <include_reference>")
        print("")
        print("Arguments:")
    ...
    include_reference_str = sys.argv[6]
    ...
    for structure_id, pdb_file in iterate_files(structures_ds):
        ...
        try:
            ...
            result = analyze_structure_distance(structure_id, pdb_file, reference_spec, distance_cutoff, restrict_spec, include_reference)
