...
def collect_and_process_structures(final_designs_folder, output_folder, budget,
                                   sequences_csv_path=None, structures_csv_path=None,
                                   structures_list_path=None):
    """
    ...
    # Save sequences CSV
    sequences_csv = sequences_csv_path or os.path.join(output_folder, "sequences.csv")
    sequences_df.to_csv(sequences_csv, index=False)
    print(f"Saved sequences to: {sequences_csv}")

    # Save structures list
    structures_csv = structures_csv_path or os.path.join(output_folder, "structures.csv")
    ...
    structures_list_file = structures_list_path or os.path.join(output_folder, 'final_structures.txt')
...
def main():
    ...
    parser.add_argument('--sequences-csv', default=None, help='Path for sequences.csv')
    parser.add_argument('--structures-csv', default=None, help='Path for structures.csv')
    parser.add_argument('--structures-list', default=None, help='Path for final_structures.txt')
    ...
    if args.extract_sequences:
        ...
        structures, sequences_df = collect_and_process_structures(
            ...
            structures_csv_path=args.structures_csv,
            structures_list_path=args.structures_list,
        )
