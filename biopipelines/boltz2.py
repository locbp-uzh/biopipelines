...
"""
    ...
    def __init__(self,
        ...
        Args:
            ...
            dsDNA: Double-stranded DNA sequences (two chains per sequence, reverse complement generated by Boltz2)
            ssRNA: Single-stranded RNA sequences (one chain per sequence)
            dsRNA: Double-stranded RNA sequences (two chains per sequence, reverse complement generated by Boltz2)
