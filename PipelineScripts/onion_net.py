...
class OnionNet(BaseConfig):
    ...
    def generate_script(self, script_path: str) -> str:
        ...
        script_content += "# OnionNet execution script\n"
        script_content += self.generate_completion_check_header()
        script_content += self.activate_environment()
        script_content += self.generate_script_run_onionnet()
        script_content += self.generate_completion_check_footer()

        return script_content

    def generate_script_run_onionnet(self) -> str:
        """Generate the OnionNet execution part of the script."""
        ...
        return f"""echo "Running OnionNet binding affinity prediction"
...
class OnionNet2(BaseConfig):
    ...
    def generate_script(self, script_path: str) -> str:
        ...
        script_content += self.generate_completion_check_header()
        script_content += self.activate_environment()
        script_content += self.generate_script_run_onionnet2()
        script_content += self.generate_completion_check_footer()

        return script_content

    def generate_script_run_onionnet2(self) -> str:
