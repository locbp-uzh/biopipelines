...
class MergeTables(BaseConfig):
    ...
    def generate_script(self, script_path: str) -> str:
        ...
        script_content += self.generate_script_run_merge()
        script_content += self.generate_completion_check_footer()

        return script_content

    def generate_script_run_merge(self) -> str:
        """Generate the merge tables execution part of the script."""
        ...
        return f"""echo "Combining analysis tables"
