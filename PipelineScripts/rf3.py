...
class RF3(BaseConfig):
    ...
    def generate_script(self, script_path: str) -> str:
        ...
        script_content += "# RF3 execution script\n"
        script_content += self.generate_completion_check_header()
        script_content += self.activate_environment()
        script_content += self.generate_script_run_rf3()
        script_content += self.generate_completion_check_footer()

        return script_content

    def generate_script_run_rf3(self) -> str:
        """Generate the RF3 execution part of the script."""
        config_file = os.path.join(self.output_folder, "rf3_config.json")
        config_data = {
        ...
        return f"""echo "Running RF3 structure prediction"
